# Ejemplo CRUD de Usuarios con Spring Boot, API RESTful, JPA, HIbernate, Postgresql, FreeMarker, VueJS y canalización DevOps (Jenkins, Git, Docker, AWS)
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
	...
	<artifactId>jenkins-spring</artifactId>
	<version>0.0.1-SNAPSHOT</version>
	<name>jenkins-spring</name>
...
```
### Creación de la interface [IUsuarioService](/src/main/java/com/formacionbdi/springboot/app/lojacar/models/service/IUsuarioService.java)
...
```
### Creación de la clase [UsuarioServImplement.java](/src/main/java/com/formacionbdi/springboot/app/lojacar/models/service/UsuarioServImplement.java)
...
```
### Crear la clase [UsuarioController.java](/src/main/java/com/formacionbdi/springboot/app/lojacar/controllers/UsuarioController.java)
...
![img](/ImagesReadme/image1.jpg)
* GET : localhost:8003/api/v1/users/1 (puede ser 1, 2 o 3 esto es de acuerdo al usuarios que quieran buscar)
![img](/ImagesReadme/image2.jpg) 
* POST: localhost:8003/api/v1/users
![img](/ImagesReadme/imagen3.jpg)
* PUT: localhost:8003/api/v1/users/1
* DELETE: localhost:8003/api/v1/users/1
![img](/ImagesReadme/imagen4.jpg)

Para probar todos estos endpoints se suguiere que lo realicen en Postman
### Crear [ViewController.java](/src/main/java/com/formacionbdi/springboot/app/lojacar/controllers/ViewController.java)
...
```
### Crear [users.js](/src/main/resources/static/users.js)
...
<p align="center">
  <img src="/ImagesReadme/imagen10.png">
</p>
...
![img](/ImagesReadme/AddRepoTravis.gif)
...
![img](/ImagesReadme/image14-1.jpg)
...
![img](/ImagesReadme/image21.jpg)


![img](/ImagesReadme/image22.jpg)
